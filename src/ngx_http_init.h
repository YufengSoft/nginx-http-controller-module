...
#ifndef _NGX_HTTP_INIT_H_INCLUDED_
#define _NGX_HTTP_INIT_H_INCLUDED_
...
nxt_array_t *ngx_http_arguments_parse(nxt_http_request_t *r);
...
#endif /* _NGX_HTTP_INIT_H_INCLUDED_ */
